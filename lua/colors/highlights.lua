...
bg("illuminatedWord", "#3b4261" .. " gui=none")
bg("illuminatedCurWord", "#3b4261" .. " gui=none")
bg("IlluminatedWordText", "#3b4261" .. " gui=none")
bg("IlluminatedWordRead", "#3b4261" .. " gui=none")
bg("IlluminatedWordWrite", "#3b4261" .. " gui=none")
